...
ggplot(data = companies_by_sector, mapping = aes(x=number_of_companies, y=reorder(sector,number_of_companies))) + labs(title="Companies in the NYSE by sector",y="Sector", x="number of companies") + geom_col() + theme_economist_white() + scale_x_continuous(expand = c(0,0))
...
ggplot(myStocks_monthly_returns, aes(x=monthly_returns)) +
  ...
  labs(title = "Monthly returns of portfolio since 01 January 2010", x = "Monthly returns", y = "Density") +
...
## Comment on riskiness of selected securities 
